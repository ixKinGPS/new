...
const youtube = new YouTube("AIzaSyD5WWyuP4-tTMFplUmIB9caLRKemLtmUHE"); //تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@692735916862603366>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  if (message.content === "Hi") {
    message.channel.send("**:heart:Hello:heart:**");
    message.channel.sendFile("");
  }
});
